...
public:
   MatrixType () : attribute(0), DataLossOK(false) {}
   MatrixType (int n) : attribute(n), DataLossOK(false) {}
   MatrixType (int n, bool dlok) : attribute(n), DataLossOK(dlok) {}
   MatrixType (const MatrixType& mt)
      : attribute(mt.attribute), DataLossOK(mt.DataLossOK) {}
   MatrixType& operator=(const MatrixType& mt)
		 { attribute = mt.attribute; DataLossOK = mt.DataLossOK; return *this; }
...
public:
   ...
   MatrixBandWidth(const int n) : lower(n), upper(n) {}
...
public:
   ...
   void Release(int tg) { tag=tg; }               // del store after t accesses
   ...
   void operator*=(Real);
   void operator/=(Real r) { operator*=(1/r); }
...
public:
   ...
   void operator=(const BaseMatrix&);
   Matrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   Matrix& operator=(const Matrix& m) { Eq(m); return *this; }
...
public:
   ...
   void operator=(const BaseMatrix&);
   SquareMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   SquareMatrix& operator=(const SquareMatrix& m) { Eq(m); return *this; }
...
public:
   nricMatrix() : row_pointer(NULL) {}
   nricMatrix(int m, int n)                     // standard declaration
		 :  Matrix(m,n), row_pointer(NULL) { MakeRowPointer(); }
   nricMatrix(const BaseMatrix& bm)             // evaluate BaseMatrix
		 :  Matrix(bm), row_pointer(NULL) { MakeRowPointer(); }
   nricMatrix& operator=(const BaseMatrix& bm)
		 { DeleteRowPointer(); Matrix::operator=(bm); MakeRowPointer(); return *this; }
   nricMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   nricMatrix& operator=(const nricMatrix& m)
		 { DeleteRowPointer(); Eq(m); MakeRowPointer(); return *this; }
   void operator<<(const BaseMatrix& X)
      { DeleteRowPointer(); Eq(X,this->Type(),true); MakeRowPointer(); }
   nricMatrix(const nricMatrix& gm) : Matrix(), row_pointer(NULL) { GetMatrix(&gm); MakeRowPointer(); }
...
public:
   ...
   void operator=(const BaseMatrix&);
   SymmetricMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   SymmetricMatrix& operator=(const SymmetricMatrix& m) { Eq(m); return *this; }
   Real& operator()(int, int);                  // access element
   Real& element(int, int);                     // access element
   Real operator()(int, int) const;             // access element
   Real element(int, int) const;                // access element
...
public:
   ...
   void operator=(const BaseMatrix&);
   UpperTriangularMatrix& operator=(const UpperTriangularMatrix& m) { Eq(m); return *this; }
   UpperTriangularMatrix(const BaseMatrix&);
   UpperTriangularMatrix(const UpperTriangularMatrix& gm) : GeneralMatrix() { GetMatrix(&gm); }
	 UpperTriangularMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   Real& operator()(int, int);                  // access element
   Real& element(int, int);                     // access element
   Real operator()(int, int) const;             // access element
   Real element(int, int) const;                // access element
...
public:
   ...
   void operator=(const BaseMatrix&);
   LowerTriangularMatrix&  operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   LowerTriangularMatrix& operator=(const LowerTriangularMatrix& m) { Eq(m); return *this; }
   Real& operator()(int, int);                  // access element
   Real& element(int, int);                     // access element
   Real operator()(int, int) const;             // access element
   Real element(int, int) const;                // access element
...
public:
   ...
   void operator=(const BaseMatrix&);
   DiagonalMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   DiagonalMatrix& operator=(const DiagonalMatrix& m) { Eq(m); return *this; }
   Real& operator()(int, int);                  // access element
...
public:
   ...
   void operator=(const BaseMatrix&);
   RowVector& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   RowVector& operator=(const RowVector& m) { Eq(m); return *this; }
   Real& operator()(int);                       // access element
   Real& element(int);                          // access element
...
public:
   ...
   void operator=(const BaseMatrix&);
   ColumnVector& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   ColumnVector& operator=(const ColumnVector& m) { Eq(m); return *this; }
   Real& operator()(int);                       // access element
   Real& element(int);                          // access element
   Real operator()(int) const;                  // access element
   Real element(int) const;                     // access element
...
public:
   ...
   ~BandMatrix() {}
   BandMatrix(int n,int lb,int ub) : lower(0), upper(0) { ReSize(n,lb,ub); CornerClear(); }
                                                // standard declaration
   BandMatrix(const BaseMatrix&);               // evaluate BaseMatrix
   void operator=(const BaseMatrix&);
   BandMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   BandMatrix& operator=(const BandMatrix& m) { Eq(m); return *this; }
   MatrixType Type() const;
   Real& operator()(int, int);                  // access element
   Real& element(int, int);                     // access element
   Real operator()(int, int) const;             // access element
...
#endif
   BandMatrix(const BandMatrix& gm) : GeneralMatrix(), lower(0), upper(0) { GetMatrix(&gm); }
   LogAndSign LogDeterminant() const;
   GeneralMatrix* MakeSolver();
   Real Trace() const;
   ...
   Real MinimumAbsoluteValue() const
      { int j, k; return GeneralMatrix::MinimumAbsoluteValue2(j, k); }
   Real Maximum() const { int j, k; return GeneralMatrix::Maximum2(j, k); }
   Real Minimum() const { int j, k; return GeneralMatrix::Minimum2(j, k); }
   void GetRow(MatrixRowCol&);
   void GetCol(MatrixRowCol&);
   void GetCol(MatrixColX&);
   void RestoreCol(MatrixRowCol&);
...
public:
   ...
   void operator=(const BaseMatrix&);
   UpperBandMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this;}
   UpperBandMatrix& operator=(const UpperBandMatrix& m) { Eq(m); return *this;}
   MatrixType Type() const;
...
public:
   ...
   void operator=(const BaseMatrix&);
   LowerBandMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this;}
   LowerBandMatrix& operator=(const LowerBandMatrix& m) { Eq(m); return *this;}
   MatrixType Type() const;
...
public:
   ...
   ~SymmetricBandMatrix() {}
   SymmetricBandMatrix(int n, int lb) : lower(0) { ReSize(n,lb); CornerClear(); }
   SymmetricBandMatrix(const BaseMatrix&);
   void operator=(const BaseMatrix&);
   SymmetricBandMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   SymmetricBandMatrix& operator=(const SymmetricBandMatrix& m) { Eq(m); return *this; }
   Real& operator()(int, int);                  // access element
   Real& element(int, int);                     // access element
   Real operator()(int, int) const;             // access element
   Real element(int, int) const;                // access element
...
#endif
   MatrixType Type() const;
   SymmetricBandMatrix(const SymmetricBandMatrix& gm) : GeneralMatrix(), lower(0) { GetMatrix(&gm); }
   GeneralMatrix* MakeSolver();
   Real SumSquare() const;
   Real SumAbsoluteValue() const;
   Real Sum() const;
...
public:
   ...
   void operator=(const BaseMatrix&);
   IdentityMatrix& operator=(const IdentityMatrix& m) { Eq(m); return *this; }
   IdentityMatrix& operator=(Real f) { GeneralMatrix::operator=(f); return *this; }
   MatrixType Type() const;
...
public:
   GenericMatrix() : gm(0) {}
	 GenericMatrix(const BaseMatrix& bm) : gm((const_cast<BaseMatrix&>(bm)).Evaluate()) { gm = gm->Image(); }
	 GenericMatrix(const GenericMatrix& bm) : BaseMatrix(), gm(bm.gm->Image()) {}
   ...
   void operator&=(const BaseMatrix&);
   void operator+=(Real);
   GenericMatrix& operator-=(Real r) { operator+=(-r); return *this; }
   void operator*=(Real);
   GenericMatrix& operator/=(Real r) { operator*=(1/r); return *this; }
...
public:
   ...
   ScaledMatrix operator*(Real sc) const { return BaseMatrix::operator*(sc); }
   friend class BaseMatrix;
   GeneralMatrix* Evaluate(MatrixType mt=MatrixTypeUnSp);
   MatrixBandWidth BandWidth() const;
...
public:
   ...
   ReturnMatrix(const GeneralMatrix* gmx) : gm(const_cast<GeneralMatrix*>(gmx)) {}
//   ReturnMatrix(GeneralMatrix&);
   MatrixBandWidth BandWidth() const;
	 void operator=(const ReturnMatrix&);
...
public:
   ...
   void operator+=(const BaseMatrix&);
   void operator-=(const BaseMatrix&);
   GetSubMatrix& operator=(const GetSubMatrix& m) { operator=((const BaseMatrix&)m); return *this; }
   void operator<<(const BaseMatrix&);
   ...
   void operator/=(Real r) { operator*=(1/r); } // divide by constant
   void Inject(const GeneralMatrix&);           // copy stored els only
   MatrixBandWidth BandWidth() const;
...
public:
   RealStarStar(Matrix& A);
	 RealStarStar(const RealStarStar&);
   ~RealStarStar() { delete [] a; }
	 void operator=(const RealStarStar&);
...
public:
   ...
   ConstRealStarStar(const ConstRealStarStar&);
   ~ConstRealStarStar() { delete [] a; }
	 void operator=(const ConstRealStarStar&);
...
//! rotate columns of a matrix @a m by quaternion @a q (elements in order w,x,y,z)
/*! Only rotates first 3 dimensions, copies "higher" dimensions unchanged so return matrix is same dimensions as @a m. */
