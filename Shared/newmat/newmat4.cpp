...
Matrix::Matrix(const BaseMatrix& M)
{
   ...
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::Rt);
   GetMatrix(gmx);
}
...
SymmetricMatrix::SymmetricMatrix(const BaseMatrix& M)
{
   REPORT  // CheckConversion(M);
   // MatrixConversionCheck mcc;
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::Sm);
   GetMatrix(gmx);
}
...
UpperTriangularMatrix::UpperTriangularMatrix(const BaseMatrix& M)
{
   REPORT // CheckConversion(M);
   // MatrixConversionCheck mcc;
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::UT);
   GetMatrix(gmx);
}
...
LowerTriangularMatrix::LowerTriangularMatrix(const BaseMatrix& M)
{
   REPORT // CheckConversion(M);
   // MatrixConversionCheck mcc;
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::LT);
   GetMatrix(gmx);
}
...
DiagonalMatrix::DiagonalMatrix(const BaseMatrix& M)
{
   REPORT //CheckConversion(M);
   // MatrixConversionCheck mcc;
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::Dg);
   GetMatrix(gmx);
}
...
IdentityMatrix::IdentityMatrix(const BaseMatrix& M)
{
   REPORT //CheckConversion(M);
   // MatrixConversionCheck mcc;
   GeneralMatrix* gmx=(const_cast<BaseMatrix&>(M)).Evaluate(MatrixType::Id);
   GetMatrix(gmx);
}
...
CroutMatrix::CroutMatrix(const BaseMatrix& m)
{
   ...
   GeneralMatrix* gm = (const_cast<BaseMatrix&>(m)).Evaluate(MatrixType::Rt);
   GetMatrix(gm);
...
void GeneralMatrix::GetMatrix(const GeneralMatrix* gmx)
{
   ...
   store=(const_cast<GeneralMatrix*>(gmx))->GetStore();
}
...
// evaluate X and copy to this
{
   ...
   GeneralMatrix* gmx = (const_cast<BaseMatrix&>(X)).Evaluate(mt);
...
{
   GeneralMatrix* gmx = const_cast<GeneralMatrix*>(&X);
   if (gmx!=this)
   {
      REPORT
      if (store)
