...
#define QUAD_INTERPOLATE 1  // borrowed from Michael Kaess' AprilTags library
...
public:
  ...
  inline std::pair<float,float> interpolate01(float x, float y) { return interpolate(2*x-1, 2*y-1); }
 ...
 private:
  fmat::Column<2,float> p0, p3, p01, p32;
#endif
