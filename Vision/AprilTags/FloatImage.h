...
public:
  ...
  explicit FloatImage(const DualCoding::Sketch<DualCoding::uchar>& sketch);
  ...
  static std::vector<float> sketchToFloats(const DualCoding::Sketch<DualCoding::uchar>& sketch);
